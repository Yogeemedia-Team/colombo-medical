...
class DRTH_ESS_Hero_Slider extends Widget_Base{

    public function get_name()
    {
        return 'drth-banner-slider';
    }

    public function get_title()
    {
        return esc_html__( 'Hero Slider', 'text-domain' );
    }
    ...
    protected function _dl_banner_slider_content_repeater_controls()
    {
        ...
        $repeater->add_control(
            'dl_image', [
                'label' => __('Slider Image', 'droit-addons-pro'),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],
        ...
        $repeater->add_control(
            '_dl_banner_title_before', [
                'label' => __('Subtitle Title', 'droit-addons-pro'),
    ...
    public function _dl_banner_content_style_controls(){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .dl_img_right' => 'text-align: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
			'banner_height',
			[
				'label' => esc_html__( 'Banner Height', 'droit-elementor-addons' ),
        ...
        $this->add_responsive_control(
			'hero_spacing',
			[
				'label' => esc_html__( 'Spacing', 'droit-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .dl_row' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
			'before_title',
			[
				'label' => esc_html__( 'Before Title', 'droit-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'after',
			]
		);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Before Title', 'droit-addons-pro'),
                'selector' => '{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content h4',
                'fields_options' => [
                    'typography' => [
                        'default' => '',
                    ],
        ...
        $this->add_responsive_control(
			'_dl_banner_before_title_Spacing',
			[
				'label' => __( 'Before Title Bottom Spacing', 'droit-addons-pro' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content h4' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
        );
        ...
        $this->add_control(
			'highlighted_text',
			[
				'label' => esc_html__( 'Highlighted Text Color', 'droit-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content h2 span' => 'color: {{VALUE}}',
				]
			]
		);
    ...
    public function _dl_banner_btn_style()
    {
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px'],
                'selectors' => [
                    '{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%'],
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => __( 'Background', 'droit-addons-pro' ),
				'types' => [ 'classic', 'gradient'],
				'selector' => '{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn:hover',
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn:hover' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn:hover' => 'border-color: {{VALUE}}',
				],
			]
		);
    ...
    public function _dl_banner_btn_style_two() {
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn_two' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px'],
                'selectors' => [
                    '{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn_two' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%'],
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn_two' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dl_banner_slider .dl_container .banner_slider_content a.theme_btn_two:hover' => 'border-color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
    ...
    public function _dl_banner_nav_style() {
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dl-slider-prev i' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dl-slider-prev i:hover' => 'color: {{VALUE}}',
				],
			]
		);
            ...
            <section class="dl_banner_slider_area">
                <div class="dl_banner_slider swiper-container dl-slider-<?php echo esc_attr($banner_id);?>" data-settings='<?php echo json_encode($banner_settings, true);?>'>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        ?>
                        <div class="swiper-slide slider_item slider_bg_color d-flex align-items-center" style="background-image: url('<?php echo esc_url( $s['_dl_banner_image']['url'] );?>');">
                            <div class="dl_container">
                                <div class="dl_row align-items-center">
                                    <div class="dl_col_lg_6 dl_col_md_6">
                                        <div class="banner_slider_content">
                                        <?php if ( !empty($s['_dl_banner_title']) ) : ?>
                                                <h4><?php echo esc_html($s['_dl_banner_title_before'])?></h4>
                                                <h2 
                                                    ...
                                                    <?php endif ?>
                                                >
                                                    <?php echo str_replace(['{', '}'], ['<span>', '</span>'], esc_html($s['_dl_banner_title'])); ?></h2>
                                            <?php endif ?>
                                            <?php if ( !empty($s['_dl_banner_content']) ) : ?>
                                                <p 
                                                    ...
                                                    <?php endif ?>
                                                >
                                                	<?php echo wp_kses_post($s['_dl_banner_content']); ?>
                                                </p>
                                            <?php endif ?>
                                    ...
                                    <?php if(!empty($s['dl_image']['url'])): ?>
                                    <div class="dl_col_md_6 dl_img_right elementor-repeater-item-<?php echo $s['_id']; ?>">
                                        <img src="<?php echo $s['dl_image']['url']; ?>" alt="image" >
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
