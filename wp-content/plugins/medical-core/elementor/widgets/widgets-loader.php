...
class Widgets_Loader{
    ...
    public static function widget_map() {
        ...
        return apply_filters('drth_elementor_widgets_loading', [
            ...
            'blog-list' => [
	            'title' => __( 'Blog List', 'droit-elementor-addons-pro' ),
	            'js' => [''],
	            'css' => ['dl_new_blog_list.min.css'],
	            'source' => 'local',
            ],

            'woo-product-cat-grid' => [
	            'title' => __( 'Woo Category', 'droit-elementor-addons-pro' ),
	            'js' => [''],
	            'css' => ['dl_woo_product_cat_grid.min.css'],
	            'source' => 'local',
            ],

            'woo-list' => [
	            'title' => __( 'Woo List', 'droit-elementor-addons-pro' ),
	            'js' => [''],
	            'css' => [],
	            'source' => 'local',
            ],
            ...
            'testimonial-pro' => [
	            'title' => __( 'Testimonial Pro', 'droit-elementor-addons-pro' ),
	            'js' => [''],
            ...
            'subscriber' => [
                'title' => __( 'Subscriber', 'droit-elementor-addons-pro' ),
                'js' => [''],
                'css' => [''],
                'source' => 'addons',
            ],
            ...
            'hero-slider' => [
                'title' => __( 'Hero Slider', 'droit-elementor-addons-pro' ),
                'js' => [],
            ...
            'parallax-img' => [
                'title' => __( 'Parallax Image', 'droit-elementor-addons-pro' ),
                'js' => [],
                'css' => ['dl_parallax_img.min.css'],
                'vendor' => [
                    'js' => ['jquery-parallax'],
                    'css' => [''],
                ],
            ...
            'breadcrumbs' => [
	            'title' => __( 'Breadcrumbs', 'droit-elementor-addons-pro' ),
	            'js' => [''],
	            'css' => ['dl_breadcrumbs.min.css'],
	            'source' => 'local',
            ],
            'blogs-grid' => [
                'title' => __( 'Post Grid', 'droit-elementor-addons-pro' ),
                'js' => [''],
                'css' => [''],
                'source' => 'addons',
            ],
            'minicart' => [
                'title' => __( 'Mini Cart', 'droit-elementor-addons-pro' ),
                'js' => [''],
                'css' => ['css/cart.css'],
                'source' => 'addons',
            ],
            ...
            'single-button' => [
                'title' => __( 'single Button', 'droit-elementor-addons-pro' ),
                'js' => [''],
            ...
            'woo-product-brand' => [
	            'title' => __( 'Woo Brand', 'droit-elementor-addons-pro' ),
	            'js' => [''],
	            'css' => ['dl_woo_product_brand.css'],
	            'source' => 'local',
            ],
