...
class Loader{
	...
	public function _init(){
		...
		if (did_action('elementor/loaded')) {
            ...
            // Page Scroll
            if( !class_exists('\DROIT_ELEMENTOR_PRO\DL_Page_Scroll')){
                self::_elementor_autoload('\DROIT_ELEMENTOR_PRO\DL_Page_Scroll');
                \DROIT_ELEMENTOR_PRO\DL_Page_Scroll::instance()->init();
            }
            //  post 

            if( !class_exists('\DROIT_ELEMENTOR_PRO\Module\Query\Posts_Query')){
                self::_elementor_autoload('\DROIT_ELEMENTOR_PRO\Module\Query\Posts_Query');
                self::_elementor_autoload('\DROIT_ELEMENTOR_PRO\Module\Query\Grid_Query');
            }
    ...
    public static function add_mapping_class(){
		$elementor = [
            ...
            'Module\Query\Posts_Query' => 'query/posts-query.php',
            'Module\Query\Grid_Query' => 'query/posts-grid.php',
		];
		return $elementor;
	}
