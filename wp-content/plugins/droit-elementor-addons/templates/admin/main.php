<div class="dl_addons_element">
    ...
    <div class="dl_addons_row dl_flex_item_center">
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          ...
          <h5 class="title"><?php esc_html_e('Documentation', 'droit-addons'); ?></h5>
          <p class="description">
            <?php esc_html_e('Get detailed and guided instruction to level up your website with the necessary set up.', 'droit-addons'); ?>
          </p> 
          <a href="https://droitthemes.com/droit-elementor-addons/docs" target="_blank" class="cu_btn dl_gradient_btn btn_1 dl-btn-small"><?php esc_html_e('Check Documentation', 'droit-addons'); ?></a>
        </div>
      </div>
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          <img src="<?php echo drdt_core()->images . 'need_help.png'; ?>" alt="Need Help?" class="dl_box_icon">
          <h5 class="title"><?php esc_html_e('Need Help?', 'droit-addons'); ?></h5>
          <p class="description">
            <?php esc_html_e('If you are stuck at anything while using our product? Reach out to us. ', 'droit-addons'); ?>
          </p>
          <a href="https://droitthemes.ticksy.com/" target="_blank" class="cu_btn dl_gradient_btn btn_1 dl-btn-small "><?php esc_html_e('Support Ticket', 'droit-addons'); ?></a>
        </div>
      </div>
  ...
  <div class="dl_addons_container" style="margin-top: 40px;">
      <div class="dl_addons_row">
          <div class="dl_col_lg_12">
  ...
  <div class="dl_addons_container" style="margin-top: 40px;">
    <div class="dl_addons_row dl_flex_item_center">
      ...
      <div class="dl_col_lg_6">
        <div class="dl_kit_section_title style_3 mr-left">
          ...
          <div class="dl_section_title_content">
            <h5 class="title"><?php esc_html_e('Missing Features', 'droit-addons'); ?></h5>
            <p class="description">
            ...
            <a href="<?php echo esc_url('https://github.com/droitlab/droit-elementor-addons-missing-features/issues/new'); ?>" target="_blank"
              class="cu_btn dl_gradient_btn btn_1 dl-btn-small mt_20"><?php esc_html_e('Request Feature', 'droit-addons'); ?></a>
          </div>
        </div>
      </div>
      <div class="dl_col_lg_6">
      ...
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          <h5 class="title"><?php esc_html_e('Show Your Love', 'droit-addons'); ?></h5>
          <img src="<?php echo drdt_core()->images . 'show_loves.svg'; ?>" alt="Show Your Love" class="dl_box_icon">
          <p class="description">
            <?php esc_html_e('If you loved our product and support, leave your two cents to boost us up. ', 'droit-addons'); ?>
          </p>
          <a href="https://wordpress.org/support/plugin/droit-elementor-addons/reviews/#new-post" target="_blank" class="cu_btn dl_gradient_btn btn_1 dl-btn-small"
            arget="_blank"><?php esc_html_e('Give a Review', 'droit-addons'); ?></a>
        </div>
      </div>
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          <h5 class="title"><?php esc_html_e('Facing an Issue or Problem?', 'droit-addons'); ?></h5>
          <img src="<?php echo drdt_core()->images . 'contribute.svg'; ?>" alt="Contribute to Droit Elementor Adons"
            class="dl_box_icon">
          <p class="description">
            <?php esc_html_e('You feel something is buggy with the product? Let us know!', 'droit-addons'); ?>
          </p>
          <a href="<?php echo esc_url('https://github.com/droitlab/droit-elementor-addons-troubleshoot/issues/new'); ?>" target="_blank"
            class="cu_btn dl_gradient_btn btn_1 dl-btn-small"><?php esc_html_e('Report an Issue', 'droit-addons'); ?></a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="dl_addons_row">
      <div class="dl_col_lg_6">
        <div class="dl_kit_section_title style_2">
          ...
          <div class="dl_section_title_content">
            <h5 class="title"><?php esc_html_e('Video Tutorials', 'droit-addons'); ?></h5>

            <p class="description">
              <?php esc_html_e('Check out these video tutorials & ease your journey. ', 'droit-addons'); ?>
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="dl_col_lg_12">
          <div class="dl-video-button">
            <a href="#" target="_blank"
              class="cu_btn dl_gradient_btn btn_1 dl-btn-small"><?php esc_html_e('View More', 'droit-addons'); ?></a>
          </div>
        </div>
      </div>
    </div>
