...
class Dl_Api extends Source_Base {
	
	const LIBRARY_OPTION_KEY = 'droit_addons_library_info';

	const LIBRARY_TIMESTAMP_CACHE_KEY = 'droit_addons_remote_update_timestamp';

	const API_INFO_URL = 'https://templates.droitthemes.com/droit-elementor-addons/';

	public function get_id() {
		return 'droit-library';
	}

	public function get_title() {
		return __( 'Droit Addons Library', 'droit-addons' );
	}
	...
	public static function request_template_data( $template_id ) {
		...
		$body = [
			...
			'template_version' => DROIT_ADDONS_VERSION_ ? DROIT_ADDONS_VERSION_ : '',
		];
